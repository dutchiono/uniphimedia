...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-brand-cream">
      <section className="relative text-white section-pad py-24 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/legacy/forest-hero.jpg')] bg-cover bg-center" />
        <div className="absolute inset-0 bg-[#0B0D12]/75" />
